<template>
    <select class="select-country" name="country" data-componentname="country" id="select-country">
        <optgroup label="Страна/Регион">
            <option value="" selected>Выберете страну или регион...</option>
